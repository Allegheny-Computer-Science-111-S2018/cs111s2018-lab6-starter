...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix/ \
                                     --checkfiles MusicGenerator.java --singlecomments 6 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "new Date()" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 5 "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "println(" --fragmentcounts 5
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 5 "String" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "String" --fragmentcounts 5
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 2 "Random" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "Random" --fragmentcounts 3
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 2 "Player" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "Player" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 3 ".play" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments ".play" --fragmentcounts 3
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 2 "Pattern" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "Pattern" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 1 "else if" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles MusicGenerator.java --fragments "else if" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the reflection contains at least 3 paragraphs
  python3 gatorgrader/gatorgrader.py --nowelcome --directories writing --checkfiles reflection.md --paragraphs 3
  determine_exit_code $?
  echo ""
